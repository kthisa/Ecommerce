...
export default function Cart({cartItems, setCartItems}) {
    ...
    function placeOrderHandler() {
        fetch(import.meta.env.REACT_APP_API_URL+'/order', {
            method: 'POST',
                    ...
                    <div className="row d-flex justify-content-between">
                        ...
                        <div className="col-12 col-lg-3 my-4">
                            <div id="order_summary">
                                ...
                                <p>Total: <span className="order-summary-values">${Number(cartItems.reduce((acc,item)=> (acc + item.product.price * item.qty), 0)).toFixed(2)}</span></p>
